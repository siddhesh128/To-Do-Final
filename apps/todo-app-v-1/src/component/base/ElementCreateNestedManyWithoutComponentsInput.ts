...
@InputType()
class ElementCreateNestedManyWithoutComponentsInput {
...
export { ElementCreateNestedManyWithoutComponentsInput as ElementCreateNestedManyWithoutComponentsInput };
